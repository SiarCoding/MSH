...
// /:https://framerusercontent.com/modules/5RVuuhL3VBkVX47PhDEv/5eZQH4OrsmG4wkxOaxsv/aNiyvfKLt.js
import { jsx as _jsx4, jsxs as _jsxs4 } from "react/jsx-runtime";
import { addFonts, addPropertyControls as addPropertyControls2, ComponentViewportProvider, ControlType as ControlType2, cx, getFonts, getFontsFromSharedStyle, resolvePageScope, RichText, SmartComponentScopedContainer, useComponentViewport, useLocaleInfo as useLocaleInfo3, useRouter as useRouter2, useVariantState, withCSS as withCSS2 } from "unframer";
...
var enabledGestures = { csi9UmY92: { hover: true }, SNIsJCBAl: { hover: true } };
var cycleOrder = ["SNIsJCBAl", "csi9UmY92"];
var serializationHash = "framer-El9Yq";
var variantClassNames = { csi9UmY92: "framer-v-3etizo", SNIsJCBAl: "framer-v-1m3sla9" };
...
var Variants = motion4.create(React2.Fragment);
var humanReadableVariantMap = { "Icon Only": "csi9UmY92", Default: "SNIsJCBAl" };
var getProps = ({ color, height, id, width, ...props }) => {
  return { ...props, bdY7mewUZ: color ?? props.bdY7mewUZ ?? "var(--token-9fe7799f-86f2-493e-bc6f-9f47ef410593, rgb(18, 18, 18))", variant: humanReadableVariantMap[props.variant] ?? props.variant ?? "SNIsJCBAl" };
};
...
var Component = /* @__PURE__ */ React2.forwardRef(function(props, ref) {
  ...
  const { style, className: className2, layoutId, variant, bdY7mewUZ, ...restProps } = getProps(props);
  const { baseVariant, classNames, clearLoadingGesture, gestureHandlers, gestureVariant, isLoading, setGestureState, setVariant, variants } = useVariantState({ cycleOrder, defaultVariant: "SNIsJCBAl", enabledGestures, ref: refBinding, variant, variantClassNames });
  const layoutDependency = createLayoutDependency(props, variants);
  const sharedStyleClassNames = [className];
  const scopingClassNames = cx(serializationHash, ...sharedStyleClassNames);
  const isDisplayed = () => {
    if (gestureVariant === "csi9UmY92-hover") return false;
    if (baseVariant === "csi9UmY92") return false;
    return true;
  };
  const router = useRouter2();
  return /* @__PURE__ */ _jsx4(LayoutGroup, { id: layoutId ?? defaultLayoutId, children: /* @__PURE__ */ _jsx4(Variants, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx4(Transition, { value: transition1, children: /* @__PURE__ */ _jsxs4(motion4.div, { ...restProps, ...gestureHandlers, className: cx(scopingClassNames, "framer-1m3sla9", className2, classNames), "data-framer-name": "Default", layoutDependency, layoutId: "SNIsJCBAl", ref: refBinding, style: { ...style }, ...addPropertyOverrides({ "csi9UmY92-hover": { "data-framer-name": void 0 }, "SNIsJCBAl-hover": { "data-framer-name": void 0 }, csi9UmY92: { "data-framer-name": "Icon Only" } }, baseVariant, gestureVariant), children: [/* @__PURE__ */ _jsxs4(motion4.div, { className: "framer-2tbmpf", "data-framer-name": "Icon Text", layoutDependency, layoutId: "ejZnWOGOo", style: { opacity: 0.8 }, variants: { "csi9UmY92-hover": { opacity: 1 }, "SNIsJCBAl-hover": { opacity: 1 } }, children: [/* @__PURE__ */ _jsx4(ComponentViewportProvider, { children: /* @__PURE__ */ _jsx4(SmartComponentScopedContainer, { className: "framer-19y9fyf-container", isAuthoredByUser: true, isModuleExternal: true, layoutDependency, layoutId: "xqr6g_xUC-container", nodeId: "xqr6g_xUC", rendersWithMotion: true, scopeId: "aNiyvfKLt", children: /* @__PURE__ */ _jsx4(Icon, { color: bdY7mewUZ, height: "100%", iconSearch: "House", iconSelection: "MagnifyingGlass", id: "xqr6g_xUC", layoutId: "xqr6g_xUC", mirrored: false, selectByList: true, style: { height: "100%", width: "100%" }, weight: "regular", width: "100%" }) }) }), isDisplayed() && /* @__PURE__ */ _jsx4(RichText, { __fromCanvasComponent: true, children: /* @__PURE__ */ _jsx4(React2.Fragment, { children: /* @__PURE__ */ _jsx4(motion4.p, { className: "framer-styles-preset-19fqac6", "data-styles-preset": "gM0kQmWMx", style: { "--framer-text-color": "var(--extracted-r6o4lv, var(--variable-reference-bdY7mewUZ-aNiyvfKLt))" }, children: "Search Projects" }) }), className: "framer-amrf0o", fonts: ["Inter"], layoutDependency, layoutId: "dFbK6m1pX", style: { "--extracted-r6o4lv": "var(--variable-reference-bdY7mewUZ-aNiyvfKLt)", "--framer-link-text-color": "rgb(0, 153, 255)", "--framer-link-text-decoration": "underline", "--variable-reference-bdY7mewUZ-aNiyvfKLt": bdY7mewUZ }, verticalAlignment: "top", withExternalLayout: true })] }), /* @__PURE__ */ _jsx4(ComponentViewportProvider, { children: /* @__PURE__ */ _jsx4(SmartComponentScopedContainer, { className: "framer-j7b2c1-container", isAuthoredByUser: true, isModuleExternal: true, layoutDependency, layoutId: "lDRHTYM3h-container", nodeId: "lDRHTYM3h", rendersWithMotion: true, scopeId: "aNiyvfKLt", style: { opacity: 0 }, children: /* @__PURE__ */ _jsx4(stdin_default, { backdropOptions: { backgroundColor: "rgba(0, 0, 0, 0.8)", transition: { damping: 60, delay: 0, mass: 1, stiffness: 500, type: "spring" }, zIndex: 10 }, height: "100%", iconColor: "var(--token-9fe7799f-86f2-493e-bc6f-9f47ef410593, rgb(18, 18, 18))", iconSize: 24, iconType: "default", id: "lDRHTYM3h", inputOptions: { clearButtonText: "Clear", clearButtonType: "icon", dividerType: "fullWidth", iconOptions: { iconColor: "rgba(0, 0, 0, 0.45)", iconSize: 18, iconType: "default" }, inputFont: {}, placeholderOptions: { placeholderColor: "rgba(0, 0, 0, 0.4)", placeholderText: "Search..." }, textColor: "var(--token-9fe7799f-86f2-493e-bc6f-9f47ef410593, rgb(18, 18, 18))" }, layoutId: "lDRHTYM3h", modalOptions: { backgroundColor: "rgb(255, 255, 255)", borderRadius: 16, heightIsStatic: true, heightTransition: { damping: 60, delay: 0, mass: 1, stiffness: 800, type: "spring" }, layoutType: "QuickMenu", shadow: { blur: 40, color: "rgba(0, 0, 0, 0.2)", spread: 0, x: 0, y: 20 }, top: 0, width: 500 }, resultOptions: { itemType: "fullWidth", subtitleOptions: { subtitleColor: "rgba(0, 0, 0, 0.4)", subtitleFont: {}, subtitleType: "path" }, titleColor: "rgb(51, 51, 51)", titleFont: {}, titleType: "h1" }, style: { height: "100%", width: "100%" }, urlScope: resolvePageScope({ webPageId: "ui9hfjwfv" }, router), width: "100%" }) }) })] }) }) }) });
});
var css2 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-El9Yq.framer-th11hg, .framer-El9Yq .framer-th11hg { display: block; }", ".framer-El9Yq.framer-1m3sla9 { align-content: center; align-items: center; cursor: pointer; display: flex; flex-direction: column; flex-wrap: nowrap; gap: 10px; height: min-content; justify-content: center; overflow: hidden; padding: 10px; position: relative; width: min-content; }", ".framer-El9Yq .framer-2tbmpf { align-content: center; align-items: center; display: flex; flex: none; flex-direction: row; flex-wrap: nowrap; gap: 4px; height: min-content; justify-content: center; overflow: hidden; padding: 0px; position: relative; width: min-content; }", ".framer-El9Yq .framer-19y9fyf-container { flex: none; height: 14px; position: relative; width: 14px; }", ".framer-El9Yq .framer-amrf0o { flex: none; height: auto; position: relative; white-space: pre; width: auto; }", ".framer-El9Yq .framer-j7b2c1-container { cursor: pointer; flex: none; height: 100%; left: calc(50.00000000000002% - 100% / 2); position: absolute; top: calc(51.428571428571445% - 100% / 2); width: 100%; z-index: 1; }", ...css];
var FrameraNiyvfKLt = withCSS2(Component, css2, "framer-El9Yq");
var stdin_default2 = FrameraNiyvfKLt;
FrameraNiyvfKLt.displayName = "Button/Search";
FrameraNiyvfKLt.defaultProps = { height: 34, width: 144 };
addPropertyControls2(FrameraNiyvfKLt, { variant: { options: ["SNIsJCBAl", "csi9UmY92"], optionTitles: ["Default", "Icon Only"], title: "Variant", type: ControlType2.Enum }, bdY7mewUZ: { defaultValue: 'var(--token-9fe7799f-86f2-493e-bc6f-9f47ef410593, rgb(18, 18, 18)) /* {"name":"Black"} */', title: "Color", type: ControlType2.Color } });
addFonts(FrameraNiyvfKLt, [{ explicitInter: true, fonts: [{ family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0460-052F, U+1C80-1C88, U+20B4, U+2DE0-2DFF, U+A640-A69F, U+FE2E-FE2F", url: "https://framerusercontent.com/assets/5vvr9Vy74if2I6bQbJvbw7SY1pQ.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0301, U+0400-045F, U+0490-0491, U+04B0-04B1, U+2116", url: "https://framerusercontent.com/assets/EOr0mi4hNtlgWNn9if640EZzXCo.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+1F00-1FFF", url: "https://framerusercontent.com/assets/Y9k9QrlZAqio88Klkmbd8VoMQc.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0370-03FF", url: "https://framerusercontent.com/assets/OYrD2tBIBPvoJXiIHnLoOXnY9M.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0100-024F, U+0259, U+1E00-1EFF, U+2020, U+20A0-20AB, U+20AD-20CF, U+2113, U+2C60-2C7F, U+A720-A7FF", url: "https://framerusercontent.com/assets/JeYwfuaPfZHQhEG8U5gtPDZ7WQ.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0000-00FF, U+0131, U+0152-0153, U+02BB-02BC, U+02C6, U+02DA, U+02DC, U+2000-206F, U+2074, U+20AC, U+2122, U+2191, U+2193, U+2212, U+2215, U+FEFF, U+FFFD", url: "https://framerusercontent.com/assets/vQyevYAyHtARFwPqUzQGpnDs.woff2", weight: "400" }, { family: "Inter", source: "framer", style: "normal", unicodeRange: "U+0102-0103, U+0110-0111, U+0128-0129, U+0168-0169, U+01A0-01A1, U+01AF-01B0, U+1EA0-1EF9, U+20AB", url: "https://framerusercontent.com/assets/b6Y37FthZeALduNqHicBT6FutY.woff2", weight: "400" }] }, ...PhosphorFonts, ...SearchFonts, ...getFontsFromSharedStyle(fonts)], { supportsExplicitInterCodegen: true });

// /:https://framerusercontent.com/modules/pDQBbGiwZCMyGxHsEuTu/dLDwRjl25zLzESFJImwH/uMU_CnPt5.js
import { jsx as _jsx5 } from "react/jsx-runtime";
import { addFonts as addFonts2, addPropertyControls as addPropertyControls3, ControlType as ControlType3, cx as cx2, getLoadingLazyAtYPosition, Image, Link, useComponentViewport as useComponentViewport2, useLocaleInfo as useLocaleInfo4, useVariantState as useVariantState2, withCSS as withCSS3 } from "unframer";
...
var cycleOrder2 = ["eb7lX50aU", "M9dNWQN5G"];
var serializationHash2 = "framer-7a670";
var variantClassNames2 = { eb7lX50aU: "framer-v-sdznhj", M9dNWQN5G: "framer-v-gughrf" };
...
var Variants2 = motion5.create(React3.Fragment);
var humanReadableVariantMap2 = { Black: "eb7lX50aU", White: "M9dNWQN5G" };
var getProps2 = ({ height, id, width, ...props }) => {
  return { ...props, variant: humanReadableVariantMap2[props.variant] ?? props.variant ?? "eb7lX50aU" };
};
...
var Component2 = /* @__PURE__ */ React3.forwardRef(function(props, ref) {
  ...
  const { baseVariant, classNames, clearLoadingGesture, gestureHandlers, gestureVariant, isLoading, setGestureState, setVariant, variants } = useVariantState2({ cycleOrder: cycleOrder2, defaultVariant: "eb7lX50aU", ref: refBinding, variant, variantClassNames: variantClassNames2 });
  const layoutDependency = createLayoutDependency2(props, variants);
  const sharedStyleClassNames = [];
  const scopingClassNames = cx2(serializationHash2, ...sharedStyleClassNames);
  return /* @__PURE__ */ _jsx5(LayoutGroup2, { id: layoutId ?? defaultLayoutId, children: /* @__PURE__ */ _jsx5(Variants2, { animate: variants, initial: false, children: /* @__PURE__ */ _jsx5(Transition2, { value: transition12, children: /* @__PURE__ */ _jsx5(Link, { href: { webPageId: "augiA20Il" }, motionChild: true, nodeId: "eb7lX50aU", scopeId: "uMU_CnPt5", children: /* @__PURE__ */ _jsx5(Image, { ...restProps, ...gestureHandlers, as: "a", background: { alt: "", fit: "fill", intrinsicHeight: 26, intrinsicWidth: 64, loading: getLoadingLazyAtYPosition(componentViewport?.y || 0), pixelHeight: 26, pixelWidth: 64, src: "https://framerusercontent.com/images/E92LDnXw6qKUHxiqQoRHL4PKgtA.svg" }, className: `${cx2(scopingClassNames, "framer-sdznhj", className2, classNames)} framer-1d3whye`, "data-framer-name": "Black", layoutDependency, layoutId: "eb7lX50aU", ref: refBinding, style: { ...style }, ...addPropertyOverrides2({ M9dNWQN5G: { "data-framer-name": "White", background: { alt: "", fit: "fill", intrinsicHeight: 26, intrinsicWidth: 64, loading: getLoadingLazyAtYPosition(componentViewport?.y || 0), pixelHeight: 26, pixelWidth: 64, src: "https://framerusercontent.com/images/D024ee5GmCNGGwOGMdJj9tZtc.svg" } } }, baseVariant, gestureVariant) }) }) }) }) });
});
var css3 = ["@supports (aspect-ratio: 1) { body { --framer-aspect-ratio-supported: auto; } }", ".framer-7a670.framer-1d3whye, .framer-7a670 .framer-1d3whye { display: block; }", ".framer-7a670.framer-sdznhj { height: 26px; overflow: visible; position: relative; text-decoration: none; width: 64px; }", ".framer-7a670.framer-v-gughrf.framer-sdznhj { aspect-ratio: 2.4615384615384617 / 1; height: var(--framer-aspect-ratio-supported, 26px); }"];
var FrameruMU_CnPt5 = withCSS3(Component2, css3, "framer-7a670");
var stdin_default3 = FrameruMU_CnPt5;
FrameruMU_CnPt5.displayName = "Misc/Logo";
FrameruMU_CnPt5.defaultProps = { height: 26, width: 64 };
addPropertyControls3(FrameruMU_CnPt5, { variant: { options: ["eb7lX50aU", "M9dNWQN5G"], optionTitles: ["Black", "White"], title: "Variant", type: ControlType3.Enum } });
addFonts2(FrameruMU_CnPt5, [{ explicitInter: true, fonts: [] }], { supportsExplicitInterCodegen: true });
